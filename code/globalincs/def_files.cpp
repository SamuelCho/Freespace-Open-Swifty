...
"	}\n"
"}\n"
"vec4 CalculateLighting(vec3 normal, vec4 diffuseMaterial, vec4 specularMaterial, float shadow)\n"
"{\n"
"	vec3 eyeDir = vec3(normalize(-position).xyz);\n"
"	vec3 lightAmbient = vec3(0.1);//vec3(gl_FrontMaterial.emission + (gl_LightModel.ambient * gl_FrontMaterial.ambient));\n"
...
"		lightSpecular += SpecularBlinnPhong(gl_FrontLightProduct[i].specular.rgb, lightDir, normal, halfVec, 80.0, NdotL) * attenuation * shadow;\n"
"	}\n"
"	lightAmbientDiffuse = lightAmbient + lightDiffuse;\n"
"	vec4 baseColor = diffuseMaterial;\n"
"	baseColor.rgb *= lightAmbientDiffuse.rgb;\n"
"	baseColor.rgb += specularMaterial.rgb * lightSpecular;\n"
"#ifdef FLAG_SPEC_MAP\n"
...
"\n"
"#ifdef FLAG_LIGHT																																												\n"
"	baseColor = CalculateLighting(normal, baseColor, specData, shadow);\n"
"#else\n"
...
" #endif\n"
"   vec4 envColour = textureCubeLod(sEnvmap, envReflectNM, 7.0);																																			\n"
" #ifdef FLAG_HDR\n"
...
"   baseColor.rgb += envColour.rgb * FresnelSchlick(max(specColour.rgb, vec3(0.04)), envReflectNM, normal);																																					\n"
"#endif																																															\n"
"																																																	\n"
"#ifdef FLAG_GLOW_MAP																																												\n"
