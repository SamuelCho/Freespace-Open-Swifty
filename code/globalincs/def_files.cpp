...
extern char* Default_dynamic_blur_fragment_shader;
//**********
...
def_file Default_files[] =
{
	...
	{ "dyn-blur-f.sdr",			Default_dynamic_blur_fragment_shader}
};
...
"	mat4 submodel_orient[950];\n"
"};\n"
"#endif\n"
"#ifdef FLAG_SHADOW_MAP\n"
"varying float Instance;\n"
"uniform int shadow_map_num;\n"
...
"	orient = submodel_orient[idx];\n"
"	blown_off = orient[3].a;\n"
"	orient[3].a = 1.0;\n"
"	//vec4 column;\n"
"	//for(int i = 0; i < 3; ++i) {\n"
"	//	column = texelFetch(transform_tex, ivec2(i, idx), 0);\n"
"	//	column[i] *= column.w;\n"
"	//	orient[i] = vec4(column.x, column.y, column.z, 0.0);\n"
"	//}\n"
"	//column = texelFetch(transform_tex, ivec2(3, idx), 0);\n"
"	//orient[3] = vec4(column.x, column.y, column.z, 1.0);\n"
"	//blown_off = column.a;\n"
"  #endif\n"
" #endif\n"
...
"		shadow_vec[0] = shadow_proj_matrix[0] * pos_shadow;\n"
"		shadow_vec[0] += 1.0;\n"
"		shadow_vec[0] *= 0.5;\n"
"		shadow_vec[0].w = shadow_vec[0].z;\n"
"		shadow_vec[0].z = 0.0;\n"
"		shadow_vec[1] = shadow_proj_matrix[1] * pos_shadow;\n"
"		shadow_vec[1] += 1.0;\n"
"		shadow_vec[1] *= 0.5;\n"
"		shadow_vec[1].w = shadow_vec[1].z;\n"
"		shadow_vec[1].z = 1.0;\n"
"		shadow_vec[2] = shadow_proj_matrix[2] * pos_shadow;\n"
"		shadow_vec[2] += 1.0;\n"
"		shadow_vec[2] *= 0.5;\n"
"		shadow_vec[2].w = shadow_vec[2].z;\n"
"		shadow_vec[2].z = 2.0;\n"
"		shadow_vec[3] = shadow_proj_matrix[3] * pos_shadow;\n"
"		shadow_vec[3] += 1.0;\n"
"		shadow_vec[3] *= 0.5;\n"
"		shadow_vec[3].w = shadow_vec[3].z;\n"
"		shadow_vec[3].z = 3.0;\n"
" #endif\n"
" #ifdef FLAG_NORMAL_MAP\n"
...
"	gl_FragData[0] = vec4(position.z, position.z * position.z, 0.0, 1.0);\n"
"	return;\n"
"#endif\n"
"#ifdef FLAG_DEFERRED																																												\n"
...
"   gl_FragData[3] = vec4(specColour.rgb * SPECULAR_FACTOR, 1.0);																																	\n"
"  #else																																															\n"
"   gl_FragData[3] = vec4(baseColor.rgb * SPEC_FACTOR_NO_SPEC_MAP, 1.0);																															\n"
"  #endif																																															\n"
"  																																																	\n"
"  #ifdef FLAG_LIGHT																																												\n"
"	// Valathil's Shadows\n"
...
"	int slice = 4;\n"
"	vec2 shadow_tex_offsets[4];\n"
"	shadow_tex_offsets[0] = vec2(0.0, 0.0);\n"
"	shadow_tex_offsets[1] = vec2(0.0, 0.5);\n"
"	shadow_tex_offsets[2] = vec2(0.5, 0.0);\n"
"	shadow_tex_offsets[3] = vec2(0.5, 0.5);\n"
"	//float shadow_tex_scales[4];\n"
"	//shadow_tex_scales[0] = 0.5;\n"
"	//shadow_tex_scales[1] = 0.5;\n"
"	//shadow_tex_scales[2] = 0.25;\n"
"	//shadow_tex_scales[3] = 0.25;\n"
"	slice -= int(step(depth, fardist));\n"
"	slice -= int(step(depth, middist));\n"
"	slice -= int(step(depth, neardist));\n"
"	slice -= int(step(depth, veryneardist));\n"
"	if(slice < 4) {\n"
"		vec2 shadow_texcoords = shadow_vec[slice].xy;\n"
"		//shadow_texcoords *= 0.5; //shadow_tex_scales[slice];\n"
"		//shadow_texcoords += shadow_tex_offsets[slice];\n"
"		//vec2 moments = texture2D(shadow_map, shadow_texcoords).xy;\n"
"		vec2 moments = texture2DArray(shadow_map, shadow_vec[slice].xyz).xy;\n"
"		if((moments.x-0.05) > pos_shadow.z)\n"
"		{ // variance shadow mapping\n"
"			float variance = moments.y - moments.x * moments.x;\n"
"			float mD = moments.x - pos_shadow.z;\n"
...
"      lightSpecular += ((gl_FrontLightProduct[i].specular.rgb * pow(NdotHV, gl_FrontMaterial.shininess)) * attenuation) * SPEC_INTENSITY_DIRECTIONAL * shadow;												\n"
"   }																																																\n"
...
"	baseColor.rgb += lightSpecular * gl_FragData[3].rgb;																																			\n"
"  #endif																																															\n"
"  																																																	\n"
"  #ifdef FLAG_ENV_MAP																																												\n"
...
"	gl_FragData[3].rgb *= fogDist;																																									\n"
"  #endif																																															\n"
"																																																	\n"
"	#ifdef FLAG_DIFFUSE_MAP\n"
"		if(desaturate == 1) {\n"
"			float intensity = 0.0;\n"
"			intensity = (baseColor.r + baseColor.g + baseColor.b)/3.0;\n"
"			float alpha = baseColor.a;\n"
"			baseColor = vec4(desaturate_r, desaturate_g, desaturate_b, 1.0) * intensity;\n"
"			baseColor.a = alpha;\n"
"		}\n"
"	#endif\n"
...
"	float shadow = 1.0;\n"
"  #ifdef FLAG_SHADOWS\n"
"	if(-position.z < fardist)\n"
"	{\n"
"		int slice = 2;\n"
"		vec2 shadow_texcoords;\n"
"		if(-position.z < middist) {\n"
"			if(-position.z < neardist) {\n"
"				slice = 0;\n"
"				shadow_texcoords = shadow_vec[slice].xy;\n"
"				shadow_texcoords *= 0.5;\n"
"			} else {\n"
"				slice = 1;\n"
"				shadow_texcoords = shadow_vec[slice].xy;\n"
"				shadow_texcoords *= 0.25;\n"
"				shadow_texcoords.x += 0.5;\n"
"			}\n"
"		} else {\n"
"			shadow_texcoords = shadow_vec[slice].xy;\n"
"			shadow_texcoords *= 0.25;\n"
"			shadow_texcoords.x += 0.5;\n"
"			shadow_texcoords.y += 0.25;\n"
"		}\n"
"		//shadow = shadow2DArray(shadow_map,shadow_vec[slice]).r;\n"
"		vec2 moments = texture2DArray(shadow_map,shadow_vec[slice].xyz).xy;\n"
"		//vec2 moments = texture2D(shadow_map, shadow_texcoords).xy;\n"
"		if((moments.x-0.01) > pos_shadow.z)\n"
"		{\n"
"			float variance = moments.y - moments.x * moments.x;\n"
"			float mD = moments.x - pos_shadow.z;\n"
"			shadow = variance / (variance + mD * mD);\n"
...
"      // Specular																																													\n"
"      float NdotHV = clamp(dot(normal, half_vec), 0.0, 1.0);																																		\n"
"      lightSpecular += ((gl_FrontLightProduct[i].specular * pow(NdotHV, gl_FrontMaterial.shininess)) * attenuation) * SPEC_INTENSITY_DIRECTIONAL * shadow;													\n"
"   }																																																\n"
"	lightAmbientDiffuse = lightAmbient + lightDiffuse;																																				\n"
" #else																																																\n"
...
" #ifdef FLAG_ANIMATED																																												\n"
"   if (effect_num == 0) {																																											\n"
"      float shinefactor = 1.0/(1.0 + pow((fract(abs(texCoord.x))-anim_timer) * 1000.0, 2.0)) * 1000.0;																								\n"
"      gl_FragData[0].rgb = fragmentColor.rgb + vec3(shinefactor);																																	\n"
"      gl_FragData[0].a = fragmentColor.a * clamp(shinefactor * (fract(abs(texCoord.x))-anim_timer) * -10000.0,0.0,1.0);																			\n"
"   }																																																\n"
"   if (effect_num == 1) {																																											\n"
"      float shinefactor = 1.0/(1.0 + pow((position.y-anim_timer), 2.0));																															\n"
"      gl_FragData[0].rgb = fragmentColor.rgb + vec3(shinefactor);																																	\n"
"    #ifdef FLAG_LIGHT																																												\n"
"      gl_FragData[0].a = fragmentColor.a;																																							\n"
"    #else																																															\n"
"      // ATI Wireframe fix *grumble*																																								\n"
"      gl_FragData[0].a = clamp((position.y-anim_timer) * 10000.0,0.0,1.0);																															\n"
"    #endif																																															\n"
"   }																																																\n"
"   if (effect_num == 2) {																																											\n"
...
"    #ifdef FLAG_LIGHT																																												\n"
"      gl_FragData[0].rgb = mix(texture2D(sFramebuffer, screenPos + distort*anim_timer + anim_timer*0.1*normal.xy).rgb,fragmentColor.rgb,clamp(cloak_interp+anim_timer*2.0,0.0,1.0));				\n"
"    #else																																															\n"
"      gl_FragData[0].rgb = mix(texture2D(sFramebuffer, screenPos + distort*anim_timer + anim_timer*0.1*lNormal.xy).rgb,fragmentColor.rgb,clamp(cloak_interp+anim_timer*2.0,0.0,1.0));				\n"
"    #endif																																															\n"
"   }																																																\n"
" #else																																																\n"
"	#ifdef FLAG_DIFFUSE_MAP\n"
...
"	//float blurSize = blurSize_g;\n"
"	float blurSize = 1.0/bsize;\n"
"	#ifdef FLAG_GEOMETRY\n"
"	//vec4 sum = texture2DArray(tex, vec3(gl_TexCoord[0].xy, Instance_p)) * BlurWeights[0];\n"
"	vec4 sum = texture2DArray(tex, vec3(gl_TexCoord[0].xy, Instance_p)) * weight[0];\n"
"	#else\n"
"	//vec4 sum = texture2D(tex, gl_TexCoord[0].xy) * BlurWeights[0];\n"
"	vec4 sum = texture2D(tex, gl_TexCoord[0].xy) * weight[0];\n"
"	#endif\n"
"#ifdef PASS_0\n"
"	for (int i = 1; i < 3; i++) {\n"
"		#ifdef FLAG_GEOMETRY\n"
"		sum += texture2DArray(tex, vec3(clamp(gl_TexCoord[0].x - offset[i] * blurSize, 0.0, 1.0), gl_TexCoord[0].y, Instance_p)) * weight[i];\n"
"		sum += texture2DArray(tex, vec3(clamp(gl_TexCoord[0].x + offset[i] * blurSize, 0.0, 1.0), gl_TexCoord[0].y, Instance_p)) * weight[i];\n"
"		//sum += texture2DArray(tex, vec3(clamp(gl_TexCoord[0].x - float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0), gl_TexCoord[0].y, Instance_p)) * BlurWeights[i];\n"
"		//sum += texture2DArray(tex, vec3(clamp(gl_TexCoord[0].x + float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0), gl_TexCoord[0].y, Instance_p)) * BlurWeights[i];\n"
"		#else\n"
"		sum += texture2D(tex, vec2(clamp(gl_TexCoord[0].x - offset[i] * blurSize, 0.0, 1.0), gl_TexCoord[0].y)) * weight[i];\n"
"		sum += texture2D(tex, vec2(clamp(gl_TexCoord[0].x + offset[i] * blurSize, 0.0, 1.0), gl_TexCoord[0].y)) * weight[i];\n"
...
"	for (int i = 1; i < 3; i++) {\n"
"		#ifdef FLAG_GEOMETRY\n"
"		//sum += texture2DArray(tex, vec3(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y - float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0), Instance_p)) * BlurWeights[i];\n"
"		//sum += texture2DArray(tex, vec3(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y + float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0), Instance_p)) * BlurWeights[i];\n"
"		sum += texture2DArray(tex, vec3(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y - offset[i] * blurSize, 0.0, 1.0), Instance_p)) * weight[i];\n"
"		sum += texture2DArray(tex, vec3(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y + offset[i] * blurSize, 0.0, 1.0), Instance_p)) * weight[i];\n"
"		#else\n"
"		//sum += texture2D(tex, vec2(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y - float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0))) * BlurWeights[i];\n"
"		//sum += texture2D(tex, vec2(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y + float(i) * (blurSize/BLUR_SIZE_DIV), 0.0, 1.0))) * BlurWeights[i];\n"
"		sum += texture2D(tex, vec2(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y - offset[i] * blurSize, 0.0, 1.0))) * weight[i];\n"
"		sum += texture2D(tex, vec2(gl_TexCoord[0].x, clamp(gl_TexCoord[0].y + offset[i] * blurSize, 0.0, 1.0))) * weight[i];\n"
"		#endif\n"
"	}\n"
"#endif\n"
...
char *Default_dynamic_blur_fragment_shader =
"#extension GL_EXT_texture_array : enable\n"
...
"																															\n"
"uniform float bsize;			// This should usually be equal to															\n"
"									// 1.0f / texture_pixel_width for a horizontal blur, and								\n"
"									// 1.0f / texture_pixel_height for a vertical blur.										\n"
"																															\n"
"#ifdef FLAG_GEOMETRY																										\n"
"uniform sampler2DArray blurSampler;		// Texture that will be blurred by this shader									\n"
"varying float Instance_p;																									\n"
"#else																														\n"
...
"#elif defined(PASS_0 && VERTICAL_BLUR_9)\n"
"const float numBlurPixelsPerSide = 4.0f;\n"
"const vec2  blurMultiplyVec      = vec2(0.0f, 1.0f);\n"
"#elif defined(PASS_1 && HORIZONTAL_BLUR_9)\n"
"const float numBlurPixelsPerSide = 4.0f;\n"
"const vec2  blurMultiplyVec      = vec2(1.0f, 0.0f);\n"
"#elif defined(PASS_0 && VERTICAL_BLUR_7)\n"
"const float numBlurPixelsPerSide = 3.0f;\n"
"const vec2  blurMultiplyVec      = vec2(0.0f, 1.0f);\n"
"#elif defined(PASS_1 && HORIZONTAL_BLUR_7)\n"
"const float numBlurPixelsPerSide = 3.0f;\n"
"const vec2  blurMultiplyVec      = vec2(1.0f, 0.0f);\n"
"#elif defined(PASS_0 && VERTICAL_BLUR_5)\n"
"const float numBlurPixelsPerSide = 2.0f;\n"
"const vec2  blurMultiplyVec      = vec2(0.0f, 1.0f);\n"
"#elif defined(PASS_1 && HORIZONTAL_BLUR_5)\n"
"const float numBlurPixelsPerSide = 2.0f;\n"
"const vec2  blurMultiplyVec      = vec2(1.0f, 0.0f);\n"
"#else\n"
...
"#ifdef FLAG_GEOMETRY\n"
"	avgValue += texture2DArray(blurSampler, vec3(gl_TexCoord[0].xy, Instance_p)) * incrementalGaussian.x;\n"
"#else\n"
...
"	#ifdef FLAG_GEOMETRY\n"
"		avgValue += texture2DArray(blurSampler, vec3(gl_TexCoord[0].xy - i * blurSize * blurMultiplyVec, Instance_p)) * incrementalGaussian.x;\n"
"		avgValue += texture2DArray(blurSampler, vec3(gl_TexCoord[0].xy + i * blurSize * blurMultiplyVec, Instance_p)) * incrementalGaussian.x;\n"
"	#else\n"
...
"	}\n"
"\n"
"	vec4 fragmentColor = avgValue / coefficientSum;\n"
"	fragmentColor.a = 1.0;\n"
...
"  varying vec3 fvec_g;\n"
"  varying float intensity_g;\n"
"  varying float width_g;\n"
" #else\n"
"  attribute vec3 up;\n"
"  varying vec3 up_g;\n"
...
"	fvec = modelViewMatrix * fvec_g[0];\n"
"	fvec = normalize(fvec);\n"
"	uvec = cross(-vec3(gl_PositionIn[0]), fvec);\n"
"	uvec = normalize(uvec);\n"
"	gl_Position = gl_ProjectionMatrix * (gl_PositionIn[0] + vec4(uvec*width_g[0]*0.5, 0.0));\n"
"	gl_FrontColor = vec4(0.0, 0.0, 0.0, intensity_g[0]);\n"
"	gl_TexCoord[0] = vec4(gl_TexCoordIn[0][0].x, 1.0, 0.0, 0.0);\n"
"	EmitVertex();\n"
"	gl_Position = gl_ProjectionMatrix * (gl_PositionIn[0] - vec4(uvec*width_g[0]*0.5, 0.0));\n"
"	gl_FrontColor = vec4(0.0, 0.0, 0.0, intensity_g[0]);\n"
"	gl_TexCoord[0] = vec4(gl_TexCoordIn[0][0].x, 0.0, 0.0, 0.0);\n"
"	EmitVertex();\n"
"	fvec = modelViewMatrix * fvec_g[1];\n"
"	fvec = normalize(fvec);\n"
"	uvec = cross(-vec3(gl_PositionIn[1]), fvec);\n"
"	uvec = normalize(uvec);\n"
"	gl_Position = gl_ProjectionMatrix * (gl_PositionIn[1] + vec4(uvec*width_g[1]*0.5, 0.0));\n"
"	gl_FrontColor = vec4(0.0, 0.0, 0.0, intensity_g[1]);\n"
"	gl_TexCoord[0] = vec4(gl_TexCoordIn[1][0].x, 1.0, 0.0, 0.0);\n"
"	EmitVertex();\n"
"	gl_Position = gl_ProjectionMatrix * (gl_PositionIn[1] - vec4(uvec*width_g[1]*0.5, 0.0));\n"
"	gl_FrontColor = vec4(0.0, 0.0, 0.0, intensity_g[1]);\n"
...
"uniform float cone_inner_angle;																					   \n"
"uniform bool dual_cone;																					   \n"
...
"		if(dual_cone) {																						   \n"
"			if(abs(conedot) < cone_angle)																	   \n"
"				discard;																					   \n"
"			else																							   \n"
"				attenuation *= smoothstep(cone_angle, cone_inner_angle, abs(conedot));						   \n"
"		} else {																							   \n"
"			if(conedot < cone_angle)																		   \n"
"				discard;																					   \n"
"			else																							   \n"
"				attenuation *= smoothstep(cone_angle, cone_inner_angle, conedot);							   \n"
"		}																									   \n"
"	}																										   \n"
...
"   gl_FragData[0].rgb += pow(NdotHV, 80.0) * SPEC_INTENSITY_POINT * specfactor * speclightcolor * attenuation;\n"
