...
"	}\n"
"}\n"
"vec4 CalculateLighting(vec3 normal, vec4 diffuseMaterial, vec4 specularMaterial, float gloss, float shadow)\n"
"{\n"
"	vec3 eyeDir = vec3(normalize(-position).xyz);\n"
"	vec3 lightAmbient = vec3(gl_FrontMaterial.emission + (gl_LightModel.ambient * gl_FrontMaterial.ambient));\n"
...
"		lightSpecular += gl_FrontLightProduct[i].specular.rgb * SpecularBlinnPhong(specularMaterial.rgb, lightDir, normal, halfVec, exp2(10.0 * gloss + 1.0), NdotL) * attenuation * shadow;\n"
"	}\n"
"	lightAmbientDiffuse = lightAmbient + lightDiffuse;\n"
"	vec4 baseColor = diffuseMaterial;\n"
"	baseColor.rgb *= lightAmbientDiffuse.rgb;\n"
"	baseColor.rgb += lightSpecular;\n"
"#ifdef FLAG_SPEC_MAP\n"
...
"\n"
"#ifdef FLAG_LIGHT																																												\n"
"	baseColor = CalculateLighting(normal, baseColor, specData, glossData, shadow);\n"
"#else\n"
...
" #ifdef FLAG_SPEC_MAP\n"
"  #ifndef FLAG_DEFERRED\n"
"	baseColor.a += (dot(gl_SecondaryColor.a, gl_SecondaryColor.a) * SPECULAR_ALPHA);\n"
"  #endif\n"
" #endif\n"
"#endif\n"
"  																																																	\n"
...
" #endif\n"
"	float mip = (1.0 - glossData) * 7.0;\n"
"	float baseMip = float(floor(mip));\n"
"	float nextMip = baseMip + 1.0;\n"
"   vec4 envColour = mix(textureCubeLod(sEnvmap, envReflectNM, baseMip), textureCubeLod(sEnvmap, envReflectNM, nextMip), fract(mip));																																			\n"
" #ifdef FLAG_HDR\n"
...
"   baseColor.rgb += envColour.rgb * FresnelSchlick(specColour.rgb, envReflectNM, normal);																																					\n"
"#endif																																															\n"
"																																																	\n"
"#ifdef FLAG_GLOW_MAP																																												\n"
...
"	gl_FragColor.rgb = max(vec3(0.0, 0.0, 0.0), ColorOut.rgb - vec3(1.0, 1.0, 1.0));\n"
"	gl_FragColor.a = 1.0;\n"
...
"			bloom += texture2DLod(bloomed, gl_TexCoord[0].xy + distort, float(mipmap)).rgb;\n"
"		}\n"
"		//bloom /= 5.0;\n"
"		color_in.rgb += bloom;\n"
"	}\n"
