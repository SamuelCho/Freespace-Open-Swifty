...
"uniform int overrideDiffuse;																																										\n"
"uniform vec3 diffuseClr;																																											\n"
"#endif																																																\n"
"#ifdef FLAG_GLOW_MAP																																												\n"
"uniform sampler2D sGlowmap;																																										\n"
"uniform int overrideGlow;																																											\n"
"uniform vec3 glowClr;																																												\n"
"#endif																																																\n"
"#ifdef FLAG_SPEC_MAP																																												\n"
"uniform sampler2D sSpecmap;																																										\n"
"uniform int overrideSpec;																																											\n"
"uniform vec4 specClr;																																												\n"
"#endif																																																\n"
"#ifdef FLAG_ENV_MAP																																												\n"
...
"	}\n"
"}\n"
"vec3 CalculateLighting(vec3 normal, vec3 diffuseMaterial, vec3 specularMaterial, float gloss, float shadow)\n"
"{\n"
...
"\n"
"#ifdef FLAG_LIGHT																																												\n"
"	baseColor.rgb = CalculateLighting(normal, baseColor.rgb, specData.rgb, glossData, shadow);\n"
"#else\n"
...
"   baseColor.rgb += envColour.rgb * specColour.rgb * FresnelSchlick(specColour.rgb, envReflectNM, normal);\n"
"#endif																																															\n"
"																																																	\n"
"#ifdef FLAG_GLOW_MAP																																												\n"
