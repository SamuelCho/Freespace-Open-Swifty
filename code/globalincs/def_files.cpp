...
"attribute float attrib_model_id;\n"
...
"void getModelTransform(inout mat4 transform, inout float blown_off, int model_id, int matrix_offset)\n"
"{\n"
"	transform[0] = texelFetch(transform_tex, (matrix_offset + model_id) * TEXELS_PER_MATRIX);\n"
"	transform[1] = texelFetch(transform_tex, (matrix_offset + model_id) * TEXELS_PER_MATRIX + 1);\n"
"	transform[2] = texelFetch(transform_tex, (matrix_offset + model_id) * TEXELS_PER_MATRIX + 2);\n"
"	transform[3] = texelFetch(transform_tex, (matrix_offset + model_id) * TEXELS_PER_MATRIX + 3);\n"
"	blown_off = 0.0;\n"
"	transform[3].w = 1.0;\n"
"	//transform = mat4(1.0);\n"
"}\n"
...
"	mat4 scale = mat4(1.0);\n"
" #ifdef FLAG_TRANSFORM\n"
"	int model_id = int(attrib_model_id);\n"
"	getModelTransform(orient, blown_off, model_id, buffer_matrix_offset);\n"
" #endif\n"
