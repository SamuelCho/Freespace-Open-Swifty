...
"void getModelTransform(inout mat4 transform, inout float invisible, int model_id, int matrix_offset)\n"
"{\n"
...
"	float invisible;"
"	getModelTransform(orient, invisible, model_id, buffer_matrix_offset);\n"
"  #ifdef FLAG_SHADOW_MAP\n"
