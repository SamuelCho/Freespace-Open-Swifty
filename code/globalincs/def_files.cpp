...
"	lNormal = normal;\n"
" #ifdef FLAG_SHADOWS\n"
"		shadow_vec[0] = shadow_proj_matrix[0] * shadow_mv_matrix * model_matrix * gl_Vertex;\n"
"		shadow_vec[0] += 1.0;\n"
"		shadow_vec[0] *= 0.5;\n"
"		shadow_vec[0].w = shadow_vec[0].z;\n"
"		shadow_vec[0].z = 0.0;\n"
"		shadow_vec[1] = shadow_proj_matrix[1] * shadow_mv_matrix * model_matrix * gl_Vertex;\n"
"		shadow_vec[1] += 1.0;\n"
"		shadow_vec[1] *= 0.5;\n"
"		shadow_vec[1].w = shadow_vec[1].z;\n"
"		shadow_vec[1].z = 1.0;\n"
"		shadow_vec[2] = shadow_proj_matrix[2] * shadow_mv_matrix * model_matrix * gl_Vertex;\n"
"		shadow_vec[2] += 1.0;\n"
"		shadow_vec[2] *= 0.5;\n"
...
"      lightDiffuse += (gl_FrontLightProduct[i].diffuse.rgb * (max(dot(normal, lightDir), 0.0)) * attenuation) * shadow;																						\n"
"      // Specular																																													\n"
