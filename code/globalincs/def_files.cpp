...
"	uvec = normalize(uvec);\n"
"	positions[0] = gl_ProjectionMatrix * (gl_PositionIn[0] + vec4(uvec*width_g[0]*0.5, 0.0));\n"
"	positions[1] = gl_ProjectionMatrix * (gl_PositionIn[0] - vec4(uvec*width_g[0]*0.5, 0.0));\n"
"	fvec = modelViewMatrix * fvec_g[1];\n"
"	fvec = normalize(fvec);\n"
"	uvec = cross(-vec3(gl_PositionIn[1]), fvec);\n"
"	uvec = normalize(uvec);\n"
"	positions[2] = gl_ProjectionMatrix * (gl_PositionIn[1] + vec4(uvec*width_g[1]*0.5, 0.0));\n"
"	positions[3] = gl_ProjectionMatrix * (gl_PositionIn[1] - vec4(uvec*width_g[1]*0.5, 0.0));\n"
