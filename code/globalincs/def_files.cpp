...
"uniform sampler1D transform_tex;\n"
"#endif\n"
...
"	for(int i = 0; i < 4; ++i) {\n"
"		orient[i] = vec4(\n"
"			texelFetch(transform_tex, i*3).x,\n"
"			texelFetch(transform_tex, i*3+1).x,\n"
"			texelFetch(transform_tex, i*3+2).x,\n"
"			1.0\n"
"		);\n"
"	}\n"
"  #endif\n"
...
"	gl_Position = gl_ProjectionMatrix * orient * gl_ModelViewMatrix * gl_Vertex;\n"
"	gl_FrontColor = gl_Color;\n"
"	gl_FrontSecondaryColor = vec4(0.0, 0.0, 0.0, 1.0);\n"
" // Transform the normal into eye space and normalize the result.\n"
"	position = orient * gl_ModelViewMatrix * gl_Vertex;\n"
...
"	gl_ClipVertex = (orient * gl_ModelViewMatrix * gl_Vertex);\n"
" #endif\n"
"}";
